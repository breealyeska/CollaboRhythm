package collaboRhythm.iHAART.model
{
	 ...
	 * Item clicked
	 */
	[Event(name="menuItemClicked", type="collaboRhythm.iHAART.model.events.MobileContextMenuEvent")]
	...
	public class MobileContextMenu extends SkinnablePopUpContainer
	{
		...
		{
			var evt:MobileContextMenuEvent = new MobileContextMenuEvent(MobileContextMenuEvent.MENU_ITEM_CLICKED,
					_menuItems[event.newIndex]);
		 ...
		 */
		public static function show(menuItems:Array,
									headerLabel:String = "",
									parent:DisplayObjectContainer = null,
									modal:Boolean = true):MobileContextMenu
		{
