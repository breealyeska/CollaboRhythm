...
package collaboRhythm.iHAART.model
{
	...
	public class SkinnableAlert extends SkinnableComponent
	{
		...
		/**
		 *  Value that enables a Take button on the Alert control
		 */
		public static const TAKE:uint = 0x0010;
		/**
		 *  Value that enables a Snooze button on the Alert control
		 */
		 ...
		 *  <code>SkinnableAlert.YES</code>, <code>SkinnableAlert.TAKE</code>, <code>SkinnableAlert.SNOOZE</code>, and/or <code>SkinnableAlert.NO</code> indicating
		...
		public static function show(text:String = "",
									...
									flags:uint = 0x4,
									parent:Sprite = null,
									closeHandler:Function = null):SkinnableAlert
		{
		...
		{
			dispatchEvent(new CloseEvent(CloseEvent.CLOSE, false, false, SkinnableAlert.TAKE));
			PopUpManager.removePopUp(this);
		}
		...
		{
			dispatchEvent(new CloseEvent(CloseEvent.CLOSE, false, false, SkinnableAlert.SNOOZE));
			PopUpManager.removePopUp(this);
		}
