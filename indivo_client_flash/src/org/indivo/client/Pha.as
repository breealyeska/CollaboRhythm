...
//        }
		 ...
		 */
		public function accounts_X_records_GET(params:Object, consumerKey:String, consumerSecret:String,
											   installationURL:String, accountId:String, accountToken:String,
											   accountTokenSecret:String, userData:Object = null):void
		{
		 ...
		 */
		public function records_XGET(consumerKey:String, consumerSecret:String, installationURL:String, recordId:String,
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function apps_GET(params:Object, consumerKey:String, consumerSecret:String, installationURL:String,
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function documents_GET(params:Object, consumerKey:String, consumerSecret:String, installationURL:String,
									  recordId:String, accessToken:String, accessTokenSecret:String,
									  userData:Object = null):void
		{
...
//        return metaFromPhaRequest;
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function documents_type_X_GET(params:Object, consumerKey:String, consumerSecret:String,
											 installationURL:String, recordId:String, type:String, accessToken:String,
...
//        return metaFromPhaRequest;
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function documents_XGET(consumerKey:String, consumerSecret:String, installationURL:String,
									   recordId:String, docId:String, accessToken:String, accessTokenSecret:String,
									   userData:Object = null):void
		{
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function special_demographicsGET(consumerKey:String, consumerSecret:String, installationURL:String,
												recordId:String, accessToken:String, accessTokenSecret:String,
												userData:Object = null):void
		{
		 ...
		 */
		public function special_demographicsPUT(consumerKey:String, consumerSecret:String, installationURL:String,
												recordId:String, accessToken:String, accessTokenSecret:String,
...
//---------------------------
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function special_contactGET(consumerKey:String, consumerSecret:String, installationURL:String,
										   recordId:String, accessToken:String, accessTokenSecret:String,
										   userData:Object = null):void
		{
		 ...
		 * @param document XML of the document to PUT
		 */
		public function special_contactPUT(consumerKey:String, consumerSecret:String, installationURL:String,
										   recordId:String, accessToken:String, accessTokenSecret:String,
										   document:String, userData:Object = null):void
		{
			var requestUrl:String = "records/" + recordId + "/contact";
...
//&&&&&&&&&&&&&&&&&&&&&&&&&&&&&&
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function documents_X_metaGET(consumerKey:String, consumerSecret:String, installationURL:String,
											recordId:String, docId:String, accessToken:String, accessTokenSecret:String,
											userData:Object = null):void
		{
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function documents_X_versions_GET(params:Object, consumerKey:String, consumerSecret:String,
												 installationURL:String, recordId:String, docId:String,
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function documents_external_X_X_metaGET(consumerKey:String, consumerSecret:String,
													   installationURL:String, recordId:String, appId:String,
													   xId:String, accessToken:String, accessTokenSecret:String,
													   userData:Object = null):void
		{
		 ...
		 */
		public function documents_POST(consumerKey:String, consumerSecret:String, installationURL:String,
									   recordId:String, accessToken:String, accessTokenSecret:String, document:String,
									   userData:Object = null):void
		{
			phaRequest(
					consumerKey, consumerSecret, installationURL,
		 ...
		 */
		public function documents_external_X_XPUT(consumerKey:String, consumerSecret:String, installationURL:String,
												  recordId:String, appId:String, xId:String, accessToken:String,
												  accessTokenSecret:String, document:String,
												  userData:Object = null):void
		{
		 ...
		 */
		public function documents_X_labelPUT(consumerKey:String, consumerSecret:String, installationURL:String,
											 recordId:String, docId:String, accessToken:String,
											 accessTokenSecret:String, newLabel:String, userData:Object = null):void
		{
		 ...
		 * @param newLabel new label
		 */
		public function documents_external_X_X_labelPUT(consumerKey:String, consumerSecret:String,
														installationURL:String, recordId:String, appId:String,
														xId:String, accessToken:String, accessTokenSecret:String,
														newLabel:String, userData:Object = null):void
		{
		 ...
		 */
		public function documents_X_replacePOST(consumerKey:String, consumerSecret:String, installationURL:String,
												recordId:String, docId:String, accessToken:String,
												accessTokenSecret:String, replacement:String,
												userData:Object = null):void
		{
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function documents_X_replace_external_X_XPUT(consumerKey:String, consumerSecret:String,
															installationURL:String, recordId:String, docId:String,
															appId:String, xId:String, accessToken:String,
															accessTokenSecret:String, replacement:String,
															userData:Object = null):void
		{
			var requestUrl:String = "records/" + recordId + "/documents/" + docId + "/replace/external/" + appId + "/" +
					xId;
			phaRequest(
					consumerKey, consumerSecret, installationURL,
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function documents_XDELETE(consumerKey:String, consumerSecret:String, installationURL:String,
										  recordId:String, docId:String, accessToken:String, accessTokenSecret:String,
										  userData:Object = null):void
		{
			var requestUrl:String = "records/" + recordId + "/documents/" + docId;
		 ...
		 */
		public function documents_X_setStatusPOST(consumerKey:String, consumerSecret:String, installationURL:String,
												  recordId:String, docId:String, accessToken:String,
												  accessTokenSecret:String, formUrlEncoded:String,
												  userData:Object = null):void
		{
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function documents_X_statusHistoryGET(consumerKey:String, consumerSecret:String, installationURL:String,
													 recordId:String, docId:String, accessToken:String,
													 accessTokenSecret:String, userData:Object = null):void
		{
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function documents_X_rels_X_XPUT(consumerKey:String, consumerSecret:String, installationURL:String,
												recordId:String, docId:String, relType:String, otherDocId:String,
												accessToken:String, accessTokenSecret:String,
												userData:Object = null):void
		{
		 ...
		 */
		public function documents_X_rels_X_POST(consumerKey:String, consumerSecret:String, installationURL:String,
												recordId:String, docId:String, relType:String, accessToken:String,
												accessTokenSecret:String, document:String, userData:Object = null):void
		{
			phaRequest(
					consumerKey, consumerSecret, installationURL,
					"POST",
		 ...
		 * @param document the new, related, document being added
		 */
		public function documents_X_rels_X_external_X_XPUT(consumerKey:String, consumerSecret:String,
														   installationURL:String, recordId:String, docId:String,
														   relType:String, appId:String, xId:String, accessToken:String,
														   accessTokenSecret:String, document:String,
														   userData:Object = null):void
		{
			var requestUrl:String = "records/" + recordId + "/documents/" + docId + "/rels/" + relType + "/external/" +
					appId + "/" + xId;
			phaRequest(
					consumerKey, consumerSecret, installationURL,
					"PUT", requestUrl, accessToken, accessTokenSecret, document, null, userData);
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function documents_X_rels_X_GET(params:Object, consumerKey:String, consumerSecret:String,
											   installationURL:String, recordId:String, docId:String, relType:String,
											   accessToken:String, accessTokenSecret:String,
											   userData:Object = null):void
		{
			var requestUrl:String = "records/" + recordId + "/documents/" + docId + "/rels/" + relType + '/';
...
//    }
		 ...
		 * @param consumerSecret OAuth consumer secret, assigned to your application by the Indivo service provider
		 * @param installationURL base URL of the Indivo server
		 * @param accountId account ID for which inbox messages will be retrieved
		 * @param accountToken OAuth token for account
		 * @param accountTokenSecret OAuth token secret for account
		 */
		public function accounts_X_inboxGET(consumerKey:String, consumerSecret:String, installationURL:String,
											accountId:String, accountToken:String, accountTokenSecret:String,
											userData:Object = null):void
		{
			var requestUrl:String = "accounts/" + accountId + "/inbox/";
			phaRequest(
					consumerKey, consumerSecret, installationURL,
					"GET", requestUrl, accountToken, accountTokenSecret, null, null, userData);
		}

		/*
		 *Get a Single Message from Inbox
		 */
		 ...
		 * @param consumerSecret OAuth consumer secret, assigned to your application by the Indivo service provider
		 * @param installationURL base URL of the Indivo server
		 * @param accountId account ID for which inbox message will be retrieved
		 * @param accountToken OAuth token for account
		 * @param accountTokenSecret OAuth token secret for account
		 * @param messageId the message_id of the single message to be retrieved
		 * */
		public function accounts_X_inbox_XGET(consumerKey:String, consumerSecret:String, installationURL:String,
											  accountId:String, accountToken:String, accountTokenSecret:String,
											  messageId:String, userData:Object = null):void
		{
		...
		/** GET /accounts/{account_id}/sent/
		 * @param consumerKey OAuth consumer key, assigned to your application by the Indivo service provider
		 * @param consumerSecret OAuth consumer secret, assigned to your application by the Indivo service provider
		 * @param installationURL base URL of the Indivo server
		 * @param accountId account ID for which sent messages will be retrieved
		 * @param accountToken OAuth token for account
		 * @param accountTokenSecret OAuth token secret for account
		 */
		public function accounts_X_sentGET(consumerKey:String, consumerSecret:String, installationURL:String,
										   accountId:String, accountToken:String, accountTokenSecret:String,
										   userData:Object = null):void
		{
			var requestUrl:String = "accounts/" + accountId + "/sent/";
			phaRequest(
					consumerKey, consumerSecret, installationURL,
					"GET", requestUrl, accountToken, accountTokenSecret, null, null, userData);
		}
		...
		/** GET /accounts/{account_id}/sent/{message_id}
		 * @param consumerKey OAuth consumer key, assigned to your application by the Indivo service provider
		 * @param consumerSecret OAuth consumer secret, assigned to your application by the Indivo service provider
		 * @param installationURL base URL of the Indivo server
		 * @param accountId account ID for which sent message will be retrieved
		 * @param accountToken OAuth token for account
		 * @param accountTokenSecret OAuth token secret for account
		 * @param messageId the message_id of the single message to be retrieved
		 * */
		public function accounts_X_sent_XGET(consumerKey:String, consumerSecret:String, installationURL:String,
											 accountId:String, accountToken:String, accountTokenSecret:String,
											 messageId:String, userData:Object = null):void
		{
			var requestUrl:String = "accounts/" + accountId + "/sent/" + messageId;
			phaRequest(
					consumerKey, consumerSecret, installationURL,
					"GET", requestUrl, accountToken, accountTokenSecret, null, null, userData);
		}
		...
		/** GET /accounts/{account_id}/send/
		 * @param params URLVariables for the message to send, which can include body, severity, message_id, and subject
		 * @param consumerKey OAuth consumer key, assigned to your application by the Indivo service provider
		 * @param consumerSecret OAuth consumer secret, assigned to your application by the Indivo service provider
		 * @param installationURL base URL of the Indivo server
		 * @param accountId account ID to which the message will be sent
		 * @param accountToken OAuth token for account
		 * @param accountTokenSecret OAuth token secret for account
		 * */
		public function accounts_X_sendPOST(requestXml:String, consumerKey:String, consumerSecret:String,
											installationURL:String, accountId:String, accountToken:String,
											accountTokenSecret:String, userData:Object = null):void
		{
			var requestUrl:String = "accounts/" + accountId + "/send/";
			phaRequest(
					consumerKey, consumerSecret, installationURL,
					"POST", requestUrl, accountToken, accountTokenSecret, requestXml, null, userData);
		}


		/*
		 *Send a Message (this is the core api spec that requires an admin app)
		 */

		/**PUT /{account_id}/inbox/{message_id}
		 * @param consumerKey OAuth consumer key, assigned to your application by the Indivo service provider
		 * @param consumerSecret OAuth consumer secret, assigned to your application by the Indivo service provider
		 * @param installationURL base URL of the Indivo server
		 * @param accountId account ID
		 ...
		 */
		public function accounts_X_inbox_XPUT(consumerKey:String, consumerSecret:String, installationURL:String,
											  accountId:String, messageId:String, accountToken:String,
											  accountTokenSecret:String, message:String, userData:Object = null):void
		{
			var requestUrl:String = "accounts/" + accountId + "/inbox/" + messageId;
			phaRequest(
					consumerKey, consumerSecret, installationURL,
		 ...
		 * @param message subject={subject}&body={body}
		 */
		public function inbox_XPUT(consumerKey:String, consumerSecret:String, installationURL:String, recordId:String,
								   messageId:String, accountToken:String, accountTokenSecret:String, message:String,
								   userData:Object = null):void
		{
		 ...
		 */
		public function inbox_X_attachments_XPUT(consumerKey:String, consumerSecret:String, installationURL:String,
												 recordId:String, messageId:String, attachmentNum:int,
												 accountToken:String, accountTokenSecret:String,
												 attachedDoc:String):void
		{
		 ...
		 * @param message subject={subject}&body={body}
		 */
		public function notifyPOST(consumerKey:String, consumerSecret:String, installationURL:String, recordId:String,
								   accountToken:String, accountTokenSecret:String, message:String):void
		{
		 ...
		 * @param appId application ID
		 */
		public function nr_apps_X_documents_GET(params:Object, consumerKey:String, consumerSecret:String,
												installationURL:String, appId:String):void
		{
		 ...
		 * @param docId document ID
		 */
		public function nr_apps_X_documents_XGET(consumerKey:String, consumerSecret:String, installationURL:String,
												 appId:String, docId:String):void
		{
		 ...
		 * @param docId document ID
		 */
		public function nr_apps_X_documents_X_metaGET(consumerKey:String, consumerSecret:String, installationURL:String,
													  appId:String, docId:String):void
		{
			return apps_X_documents_X_metaGET(consumerKey, consumerSecret, installationURL, null, appId, docId, null,
					null);
		}
		 ...
		 * @param xId external ID (application supplied ID)
		 */
		public function nr_apps_X_documents_external_X_metaGET(consumerKey:String, consumerSecret:String,
															   installationURL:String, appId:String, xId:String):void
		{
			return apps_X_documents_external_X_metaGET(consumerKey, consumerSecret, installationURL, null, appId, xId,
					null, null);
		}
		 ...
		 * @param document XML document to POST
		 */
		public function nr_apps_X_documents_POST(consumerKey:String, consumerSecret:String, installationURL:String,
												 appId:String, document:String):void
		{
			return apps_X_documents_POST(consumerKey, consumerSecret, installationURL, null, appId, null, null,
					document);
		}
		 ...
		 * @param xId external ID (application supplied ID)
		 */
		public function nr_apps_X_documents_external_XPUT(consumerKey:String, consumerSecret:String,
														  installationURL:String, appId:String, xId:String,
														  docToAdd:String):void
		{
			return apps_X_documents_external_XPUT(consumerKey, consumerSecret, installationURL, null, appId, xId, null,
					null, docToAdd);
		}
		 ...
		 * @param newLabel new label
		 */
		public function nr_apps_X_documents_X_labelPUT(consumerKey:String, consumerSecret:String,
													   installationURL:String, appId:String, docId:String,
													   newLabel:String):void
		{
			return apps_X_documents_X_labelPUT(consumerKey, consumerSecret, installationURL, null, appId, docId,
					newLabel, null, null);
		}
		 ...
		 * @param docId document ID
		 */
		public function nr_apps_X_documents_XDELETE(consumerKey:String, consumerSecret:String, installationURL:String,
													appId:String, docId:String):void
		{
			return apps_X_documents_XDELETE(consumerKey, consumerSecret, installationURL, null, appId, docId, null,
					null);
		}
		 ...
		 */
		public function nr_apps_X_inbox_GET(params:Object, consumerKey:String, consumerSecret:String,
											installationURL:String, appId:String):void
		{
		 ...
		 */
		public function nr_apps_X_inbox_XGET(consumerKey:String, consumerSecret:String, installationURL:String,
											 appId:String, messageId:String):void
		{
		 ...
		 */
		public function nr_apps_X_inbox_X_attachments_XGET(consumerKey:String, consumerSecret:String,
														   installationURL:String, appId:String, messageId:String,
														   attachmentNum:int):void
		{
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function apps_X_documents_GET(params:Object, consumerKey:String, consumerSecret:String,
											 installationURL:String, recordId:String, appId:String, accessToken:String,
											 accessTokenSecret:String, userData:Object = null):void
		{
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function apps_X_documents_XGET(consumerKey:String, consumerSecret:String, installationURL:String,
											  recordId:String, appId:String, docId:String, accessToken:String,
											  accessTokenSecret:String, userData:Object = null):void
		{
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function apps_X_documents_X_metaGET(consumerKey:String, consumerSecret:String, installationURL:String,
												   recordId:String, appId:String, docId:String, accessToken:String,
												   accessTokenSecret:String, userData:Object = null):void
		{
			var requestUrl:String = null;
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function apps_X_documents_external_X_metaGET(consumerKey:String, consumerSecret:String,
															installationURL:String, recordId:String, appId:String,
															xId:String, accessToken:String, accessTokenSecret:String,
															userData:Object = null):void
		{
		 ...
		 * @param document XML document to POST
		 */
		public function apps_X_documents_POST(consumerKey:String, consumerSecret:String, installationURL:String,
											  recordId:String, appId:String, accessToken:String,
											  accessTokenSecret:String, document:String):void
		{
			var requestURL:String = null;
			if (recordId == null)
			{
		 ...
		 * @param document XML document to POST
		 */
		public function apps_X_documents_external_XPUT(consumerKey:String, consumerSecret:String,
													   installationURL:String, recordId:String, appId:String,
													   xId:String, accessToken:String, accessTokenSecret:String,
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function apps_X_documents_X_labelPUT(consumerKey:String, consumerSecret:String, installationURL:String,
													recordId:String, appId:String, docId:String, newLabel:String,
													accessToken:String, accessTokenSecret:String,
													userData:Object = null):void
		{
			var requestUrl:String = null;
...
//    }
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function apps_X_documents_types_X_GET_HL(consumerKey:String, consumerSecret:String,
														installationURL:String, recordId:String, appId:String,
														type:String, accessToken:String, accessTokenSecret:String,
														userData:Object = null):void
		{
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function reports_minimal_measurements_X_GET(params:Object, consumerKey:String, consumerSecret:String,
														   installationURL:String, recordId:String, measType:String,
														   accessToken:String, accessTokenSecret:String,
														   userData:Object = null):void
		{
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function reports_minimal_vitals_X_GET(params:Object, consumerKey:String, consumerSecret:String,
													 installationURL:String, recordId:String, category:String,
													 accessToken:String, accessTokenSecret:String,
													 userData:Object = null):void
		{
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function reports_minimal_X_GET(params:Object, consumerKey:String, consumerSecret:String,
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function shares_POST(consumerKey:String, consumerSecret:String, installationURL:String, recordId:String,
									accountId:String, roleLabel:String, accessToken:String, accessTokenSecret:String,
									userData:Object = null):void
		{
		 ...
		 * @param accessTokenSecret OAuth token secret for access to record
		 */
		public function shares_X_delete_POST(consumerKey:String, consumerSecret:String, installationURL:String,
											 recordId:String, accountId:String, accessToken:String,
											 accessTokenSecret:String, userData:Object = null):void
		{
			phaRequest(
					consumerKey, consumerSecret, installationURL,
...
//    }
		 ...
		 */
		public function phaRequest(consumerToken:String, consumerSecret:String, foreignURL:String, reqMeth:String,
								   relativePath:String, phaToken:String, phaTokenSecret:String, requestXml:String,
								   params:Object = null, userData:Object = null):IndivoRequestHandler
		{
...
//        return phaAdminUtils.docFromConnection(urlRequest);
		...
		public function phaRequestJSON(consumerToken:String, consumerSecret:String, foreignURL:String, reqMeth:String,
									   relativePath:String, params:Object, phaToken:String, phaTokenSecret:String,
...
//    }
		...
		private function phaRequestPart1(consumerToken:String, consumerSecret:String, foreignURL:String, reqMeth:String,
										 relativePath:String, params:Object, phaToken:String, phaTokenSecret:String,
										 requestXml:String):URLRequest
		{
			logger.info(reqMeth + " " + relativePath + (params ? ", params=" + params.toString() : "") +
...
//    }
		...
		private function signWithSignpost(urlRequest:URLRequest, consumerKey0:String, consumerSecret0:String,
										  accessToken:String, accessTokenSecret:String):void
		{
