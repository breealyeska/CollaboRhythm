package collaboRhythm.core.model
{
	...
	/**
	 *  The HierarchicalCollectionViewEx class provides a hierarchical view of a standard collection.
	 *
	 *  @mxml
	 *
	 *  The <code>&lt;mx.HierarchicalCollectionViewEx&gt;</code> inherits all the tag attributes of its superclass, 
	 *  and defines the following tag attributes:</p>
	 *
	 *  <pre>
	 *  &lt;mx:HierarchicalCollectionViewEx
	 *  <b>Properties </b>
	 *    showRoot="true|false"
	 ...
	 */
	public class HierarchicalCollectionViewEx extends EventDispatcher
...
//	    include "../core/Version.as";
	     ...
	     *  @productversion Flex 3
	     */
	    public function HierarchicalCollectionViewEx(
	     ...
	     *  @private
	     */
	    private var cursor:HierarchicalCollectionViewCursorEx;
	    ...
	    {
	        return new HierarchicalCollectionViewCursorEx(
	     ...
	     */
	    protected function sortCanBeApplied(coll:ICollectionView):Boolean
	    {
	        if (sort == null)
	            return true;
